...
RSpec.describe SocialsController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all socials as @socials" do
      ...
      expect(assigns(:socials)).to eq([social])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested social as @social" do
      ...
      expect(assigns(:social)).to eq(social)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new social as @social" do
      ...
      expect(assigns(:social)).to be_a_new(Social)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created social as @social" do
        post :create, {:social => valid_attributes}, valid_session
        expect(assigns(:social)).to be_a(Social)
        expect(assigns(:social)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved social as @social" do
        post :create, {:social => invalid_attributes}, valid_session
        expect(assigns(:social)).to be_a_new(Social)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested social" do
        social = Social.create! valid_attributes
        put :update, {:id => social.to_param, :social => new_attributes}, valid_session
        social.reload
    ...
    describe "with invalid params" do
      it "assigns the social as @social" do
        social = Social.create! valid_attributes
        put :update, {:id => social.to_param, :social => invalid_attributes}, valid_session
        expect(assigns(:social)).to eq(social)
      end
